function [ AnkleArtSurf, ankleCenter, EpiTibAS ] = RTibiaFun_modified( ProxTib , DistTib)

%% Modified version here doesn't refine the tibio-femoral articulating surfaces
%  as much as main version, as this is not needed for our purpose. It also
%  only exports the ankle and TF articulating surfaces.
...
%% COMMENTED OUT CODE TO AVOID JCSs
